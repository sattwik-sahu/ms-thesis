\begin{tikzpicture}[
	...
	enc_style/.style={block, draw=Cerulean, thick, fill=Cerulean!5, minimum width=1.6cm, minimum height=0.8cm, rounded corners=2pt},
	pred_style/.style={block, draw=Dandelion, thick, fill=Dandelion!5, minimum width=1.6cm, minimum height=0.8cm, rounded corners=2pt},
	loss_style/.style={block, draw=Gray, thick, fill=White, minimum width=1.6cm, minimum height=0.7cm, rounded corners=2pt},
	...
	\node [enc_style, fill=BlueViolet!5, draw=BlueViolet] (g_phi) at (1.8, 1.8) {$g_\phi$};
	...
	\node [rectangle, draw=OrangeRed, fill=OrangeRed!5, thick, minimum width=1.2cm, minimum height=1cm, rounded corners=3pt]
	...
	\draw [arrow, dashed, OrangeRed!30, line width=0.8pt] (d1) -- (d2);
	\draw [arrow, dashed, OrangeRed!30, line width=0.8pt] (d2) -- (dK);
	\draw [arrow, dashed, OrangeRed!30, line width=0.8pt] (dK) -- (final_loss.west);
