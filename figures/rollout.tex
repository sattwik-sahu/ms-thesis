\begin{tikzpicture}[
	...
	(final_loss) at (15.2, -1.25) {$\displaystyle \mathcal{L}_{\mathrm{RO}}$};
	...
	\draw [arrow, dashed, BrickRed, line width=0.8pt] (d1) -- (d2);
	\draw [arrow, dashed, BrickRed, line width=0.8pt] (d2) -- (dK);
	\draw [arrow, dashed, BrickRed, line width=0.8pt] (dK) -- (final_loss.west);
